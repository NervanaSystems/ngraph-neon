...
from neon.op_graph.op_graph import Op, computation
from neon.util.names import NameableValue
from orderedset import OrderedSet

from neon.util.trace_events import is_tracing_enabled
...
class Transformer(with_metaclass(Transformer_ABC_Meta, object)):
    ...
    Attributes:
        ...
        all_results (:obj:`set` of :class:`neon.op_graph.op_graph.Op`):  A root set of Ops that
            need to be computed.
